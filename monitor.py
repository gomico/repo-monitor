...
REPORT_GROUPS = (
    # (分组名, 阈值, 填充色, 文字色, 区间说明)
    # “大量 / 中等 / 少量”走同一条绿色阶，由深到浅表示量级；
    # “无变化”保持中性灰，“失败”保留红色作为页面上唯一的告警色。
    ("大量", 10000, "#15803d", "#14532d", "≥ 10,000 字"),
    ("中等", 1000, "#22c55e", "#15803d", "1,000 – 9,999 字"),
    ("少量", 1, "#86efac", "#15803d", "1 – 999 字"),
...
def _render_day(
    ...
    main_day = (
        ...
        f'<div class="heatkey"><b>趋势格档位</b>（每格 = 当日变化量 · 字）：{heat_key}</div></div>'
        f'</section>'
    )
